...
woff = path + "/webfonts/woff/style_183113.woff";
if (http) {
...
//test for eot
eot = path + "/webfonts/eot/style_183113.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for svg
svg = path + "/webfonts/svg/style_183113.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for css
css = path + "/webfonts/datacss/MyFontsWebfontsOrderM2771503.css";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
woff = path + "/webfonts/woff/style_4879.woff";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('Woff_result','error',"WOFF File: " +woff+ " is inaccessable.  Check the file permissions and the MIME types");
//test for eot
eot = path + "/webfonts/eot/style_4879.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('eot_result','error',"EOT File: " +eot+" is inaccessable.  Check the file permissions and the MIME types");
//test for svg
svg = path + "/webfonts/svg/style_4879.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
woff = path + "/webfonts/woff/style_4878.woff";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('Woff_result','error',"WOFF File: " +woff+ " is inaccessable.  Check the file permissions and the MIME types");
//test for eot
eot = path + "/webfonts/eot/style_4878.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('eot_result','error',"EOT File: " +eot+" is inaccessable.  Check the file permissions and the MIME types");
//test for svg
svg = path + "/webfonts/svg/style_4878.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
